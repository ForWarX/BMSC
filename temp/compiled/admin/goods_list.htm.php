...
<table cellpadding="3" cellspacing="1">
  <tr>
    ...
    <th><a href="javascript:listTable.sort('goods_weight'); "><?php echo $this->_var['lang']['goods_weight']; ?></a><?php echo $this->_var['sort_goods_weight']; ?></th>
    ...
    <th><a href="javascript:listTable.sort('is_shipping'); "><?php echo $this->_var['lang']['is_free_ship']; ?></a><?php echo $this->_var['sort_is_shipping']; ?></th>
...
?>
  <tr>
    ...
    <td align="right"><span onclick="listTable.edit(this, 'edit_goods_weight', <?php echo $this->_var['goods']['goods_id']; ?>)"><?php echo $this->_var['goods']['goods_weight']; ?>
    ...
    <td align="center"><img src="images/<?php if ($this->_var['goods']['is_shipping']): ?>yes<?php else: ?>no<?php endif; ?>.gif" onclick="listTable.toggle(this, 'toggle_shipping', <?php echo $this->_var['goods']['goods_id']; ?>)" /></td>
