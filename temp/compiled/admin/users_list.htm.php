...
<div class="form-div">
  <form action="javascript:searchUser()" name="searchForm">
    ...
    &nbsp;<input type="button" name="export" value="<?php echo $this->_var['lang']['export']; ?>" onclick="location.href='users.php?act=export';" class="button" />
    &nbsp;<input type="button" name="download" value="下载会员列表" onclick="location.href='users.php?act=download';" class="button" />
  </form>
</div>
...
<table cellpadding="3" cellspacing="1">
  <tr>
    ...
    <th><a href="javascript:listTable.sort('user_money'); ">加币余额</a></th>
    <th><a href="javascript:listTable.sort('user_money_cny'); ">人民币余额</a></th>
...
?>
  <tr>
    ...
    <td><?php echo $this->_var['user']['user_money_cny']; ?></td>
