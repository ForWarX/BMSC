      <tr>
        ...
        <td>
          ...
          <?php $_from = $this->_var['var']['store_options']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('k', 'opt_0_11492200_1435006649');if (count($_from)):
    foreach ($_from AS $this->_var['k'] => $this->_var['opt_0_11492200_1435006649']):
?>
          <label for="value_<?php echo $this->_var['var']['id']; ?>_<?php echo $this->_var['k']; ?>"><input type="radio" name="value[<?php echo $this->_var['var']['id']; ?>]" id="value_<?php echo $this->_var['var']['id']; ?>_<?php echo $this->_var['k']; ?>" value="<?php echo $this->_var['opt_0_11492200_1435006649']; ?>"
            <?php if ($this->_var['var']['value'] == $this->_var['opt_0_11492200_1435006649']): ?>checked="true"<?php endif; ?>
            <?php if ($this->_var['var']['code'] == 'rewrite'): ?>
              onclick="return ReWriterConfirm(this);"
            <?php endif; ?>
            <?php if ($this->_var['var']['code'] == 'smtp_ssl' && $this->_var['opt_0_11492200_1435006649'] == 1): ?>
              onclick="return confirm('<?php echo $this->_var['lang']['smtp_ssl_confirm']; ?>');"
            <?php endif; ?>
            <?php if ($this->_var['var']['code'] == 'enable_gzip' && $this->_var['opt_0_11492200_1435006649'] == 1): ?>
              onclick="return confirm('<?php echo $this->_var['lang']['gzip_confirm']; ?>');"
            <?php endif; ?>
            <?php if ($this->_var['var']['code'] == 'retain_original_img' && $this->_var['opt_0_11492200_1435006649'] == 0): ?>
          ...
          <?php elseif ($this->_var['var']['type'] == "manual"): ?>
            ...
            <?php if ($this->_var['var']['code'] == "shop_country"): ?>
              <select name="value[<?php echo $this->_var['var']['id']; ?>]" id="selCountries" onchange="region.changed(this, 1, 'selProvinces')">
                ...
                <?php $_from = $this->_var['countries']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'region_0_11577000_1435006649');if (count($_from)):
    foreach ($_from AS $this->_var['region_0_11577000_1435006649']):
?>
                  <option value="<?php echo $this->_var['region_0_11577000_1435006649']['region_id']; ?>" <?php if ($this->_var['region_0_11577000_1435006649']['region_id'] == $this->_var['cfg']['shop_country']): ?>selected<?php endif; ?>><?php echo $this->_var['region_0_11577000_1435006649']['region_name']; ?></option>
                <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
              </select>
              ...
              <select name="value[<?php echo $this->_var['var']['id']; ?>]" id="selProvinces" onchange="region.changed(this, 2, 'selCities')">
                <option value=''><?php echo $this->_var['lang']['select_please']; ?></option>
                <?php $_from = $this->_var['provinces']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'region_0_11593500_1435006649');if (count($_from)):
    foreach ($_from AS $this->_var['region_0_11593500_1435006649']):
?>
                  <option value="<?php echo $this->_var['region_0_11593500_1435006649']['region_id']; ?>" <?php if ($this->_var['region_0_11593500_1435006649']['region_id'] == $this->_var['cfg']['shop_province']): ?>selected<?php endif; ?>><?php echo $this->_var['region_0_11593500_1435006649']['region_name']; ?></option>
                <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
              </select>
            <?php elseif ($this->_var['var']['code'] == "shop_city"): ?>
              <select name="value[<?php echo $this->_var['var']['id']; ?>]" id="selCities">
                <option value=''><?php echo $this->_var['lang']['select_please']; ?></option>
                <?php $_from = $this->_var['cities']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'region_0_11609500_1435006649');if (count($_from)):
    foreach ($_from AS $this->_var['region_0_11609500_1435006649']):
?>
                  <option value="<?php echo $this->_var['region_0_11609500_1435006649']['region_id']; ?>" <?php if ($this->_var['region_0_11609500_1435006649']['region_id'] == $this->_var['cfg']['shop_city']): ?>selected<?php endif; ?>><?php echo $this->_var['region_0_11609500_1435006649']['region_name']; ?></option>
                <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
              </select>
