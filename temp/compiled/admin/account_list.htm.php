    ...
    <tr>
      ...
      <td align="right">
        ...
        <?php elseif ($this->_var['account']['user_money'] < 0): ?>
          <span style="color:#EF5A2C"><?php echo $this->_var['account']['user_money']; ?></span>
        <?php else: ?>
      ...
      <td align="right">
        ...
        <?php elseif ($this->_var['account']['frozen_money'] < 0): ?>
          <span style="color:#EF5A2C"><?php echo $this->_var['account']['frozen_money']; ?></span>
        <?php else: ?>
      ...
      <td align="right">
        ...
        <?php elseif ($this->_var['account']['rank_points'] < 0): ?>
          <span style="color:#EF5A2C"><?php echo $this->_var['account']['rank_points']; ?></span>
        <?php else: ?>
      ...
      <td align="right">
        ...
        <?php elseif ($this->_var['account']['pay_points'] < 0): ?>
          <span style="color:#EF5A2C"><?php echo $this->_var['account']['pay_points']; ?></span>
        <?php else: ?>
