...
{
    return array(
		'is_shipping'    => $GLOBALS['_LANG']['is_free_ship'],
...
function goods_list($is_delete, $real_goods=1, $conditions = '')
{
    ...
    if ($result === false)
    {
        ...
        $sql = "SELECT goods_id, goods_name, goods_type, goods_sn, shop_price, goods_weight, is_on_sale, is_shipping, is_best, is_new, is_hot, sort_order, goods_number, integral, " .
