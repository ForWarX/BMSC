...
function assign_template($ctype = '', $catlist = array())
{
	...
	if (isset($_SESSION['language']) === false){$language_a = '<a class="a1" href="language.php?language=en">English</a>';}
	else {$language = $_SESSION['language'];}
	if ($language == ''){$language_a = '<a class="a1" href="language.php?language=en">English</a>';}
	else if ($language == '_en'){$language_a = '<a class="a1" href="language.php">中文</a>';}
