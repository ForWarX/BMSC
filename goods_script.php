...
if (!$smarty->is_cached($tpl, $cache_id))
{
    ...
    if ($type == '')
    {
        ...
        if (!empty($_GET['intro_type']))
        {
            ...
            if ($_GET['intro_type'] == 'is_shipping' || $_GET['intro_type'] == 'is_best' || $_GET['intro_type'] == 'is_new' || $_GET['intro_type'] == 'is_hot' || $_GET['intro_type'] == 'is_promote' || $_GET['intro_type'] == 'is_random')
            {
